<template>
  <el-container style="height:100%;background-color:#ccc">
    <el-aside width="250px" style="background-color:#2e2f32;height:100%;overflow:hidden">
      <div class="logo_hd">
        <img
      ...
      <el-menu
        ...
        router
        style="height:100%"
        :default-active="$store.state.activeDefalut"
      ...
      >
        ...
        <el-submenu index="2">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/manage">素材管理</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="3">
          <template slot="title">
    ...
    <el-container>
      <el-header style="background-color:#fff;height:80px;margin-bottom:10px" class="hd">
        <h3>江苏传智播客教育科技股份有限公司</h3>
        <el-dropdown @command="handleCommand">
          <span class="el-dropdown-link">
            <img :src="$store.state.userInfo.photo" class="photo" alt />
